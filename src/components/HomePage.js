    ...
    <>
      <div className="main">
        ...
        <div className="main-body">
          <div>
            <h2 className="mb-5 mt-5">Learn to code — for free.</h2>
            <h2 className="mb-5 ">Build projects.</h2>
            <h2 className="mb-5 ">Earn certifications.</h2>
            <h4>
              Since 2014, more than 40,000 freeCodeCamp.org graduates have
              gotten jobs at tech companies including:
            </h4>
            <div className="icons d-flex justify-content-between my-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="35"
                height="35"
